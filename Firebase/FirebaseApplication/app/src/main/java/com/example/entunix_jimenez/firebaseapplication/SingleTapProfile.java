...
public class SingleTapProfile extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.single_tap_activity);
        ...
        tv_profile_welcome.setText("SINGLE TAP ATTEMPTS");
    }
                ...
                for(DataSnapshot gestureSnapshot: dataSnapshot.getChildren()){
                    ...
                    databaseGestureDetails.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            GestureList adapter = new GestureList(SingleTapProfile.this, gestureDetailsList);
