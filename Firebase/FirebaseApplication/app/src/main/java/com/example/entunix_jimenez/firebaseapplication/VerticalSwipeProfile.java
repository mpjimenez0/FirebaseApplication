...
public class VerticalSwipeProfile extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vertical_swipe_profile);
        ...
        tv_profile_welcome.setText("VERTICAL SWIPE ATTEMPTS");
    }
        ...
        databaseGestureDetails.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot gestureSnapshot: dataSnapshot.getChildren()){
                    ...
                    databaseGestureDetails = FirebaseDatabase.getInstance().getReferenceFromUrl("https://fir-application-8e6b4.firebaseio.com/Gestures/" + user.getUid() + "/" + x + "/Vertical Swipe");
                    databaseGestureDetails.addValueEventListener(new ValueEventListener() {
                        @Override
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            for(DataSnapshot gestureSnapshot: dataSnapshot.getChildren()){
                            ...
                            GestureList adapter = new GestureList(VerticalSwipeProfile.this, gestureDetailsList);
