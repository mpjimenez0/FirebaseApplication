...
public class ScrollProfile extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scroll_profile);
        ...
        tv_profile_welcome.setText("SCROLL ATTEMPTS");
    }
                ...
                for(DataSnapshot gestureSnapshot: dataSnapshot.getChildren()){
                    ...
                    databaseGestureDetails.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            GestureList adapter = new GestureList(ScrollProfile.this, gestureDetailsList);
