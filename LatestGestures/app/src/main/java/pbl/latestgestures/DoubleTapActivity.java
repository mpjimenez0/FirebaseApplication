...
public class DoubleTapActivity extends AppCompatActivity implements
    ...
    List<DoubleTapActivity.TapData> Data = new ArrayList<DoubleTapActivity.TapData>();
...
//        });
        ...
        submitData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (tapCount == 0) {
                    Toast.makeText(DoubleTapActivity.this, "No Gesture Yet", Toast.LENGTH_SHORT).show();
                } else {
                    nextCount++;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (touchDuration < 500) {
            ...
            if (Math.abs(curPos - downPos) > singleTapRadius) {
                ...
                DoubleTapActivity.TapData data = new DoubleTapActivity.TapData();
...
//        GestureDetails gestureDetails = new GestureDetails(x, y, sX, sY, fX, fY, totalTime, myName, deviceName, deviceMan);
        ...
        databaseVelocity.child("Velocity").child("DoubleTap").child(gestureNum).child(id).setValue(velocity);
        databaseGestureDetails.child("Gesture Details").child("DoubleTap").child(gestureNum).child(tapGestureId).setValue(gestureDetails);
